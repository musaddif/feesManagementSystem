...
const StudentList = () => {
  ...
  const download = (student) => {
    // console.log("Downloading data for students:", student);
    const formattedData = student.map((student) => ({
      ...
      "CRF": student?.feeSubmission?.[0]?.fee_type?.CRF
        ? "Paid"
        : "Pending",
      "Admission Fee": student?.feeSubmission?.[0]?.fee_type?.admission_fee
        ? "Paid"
        : "Pending",
      "College Fee": student?.feeSubmission?.[0]?.fee_type?.college_fee
        ? "Paid"
        : "Pending",
      "Exam Fee": student?.feeSubmission?.[0]?.fee_type?.exam_fee
        ? "Paid"
        : "Pending",
      "ID Card Fee": student?.feeSubmission?.[0]?.fee_type?.id_card_fee
        ? "Paid"
        : "Pending",
      "Registration Fee": student?.feeSubmission?.[0]?.fee_type?.registration_fee
        ? "Paid"
        : "Pending",
      "Fee Submission":
                  ...
                  {students?.length > 0 ? (
                    students.map((student, index) => (
                      <tr className="tableRow" key={index}>
                        ...
                        <td className="tableData">
                          {currentSemester && (currentSemester == "2nd" ||
                            currentSemester == "4th" || currentSemester == "6th"
                            || currentSemester == "8th" || currentSemester == "10th")
                            ? "Nil"
                            : student?.feeSubmission?.[0]?.fee_type?.id_card_fee
                              ? "Paid"
                              : "-"}
                          ...
                          className={`tableData ${(() => {
                            ...
                            const isClear =
                              feeType.CRF &&
                                ...
                                currentSemester == "2nd" || currentSemester == "4th" || currentSemester == "6th" || currentSemester == "7th" || currentSemester == "9th"
                                ? true
                                : feeType.id_card_fee;
                          ...
                          {(() => {
                            ...
                            const isClear =
                              feeType.CRF &&
                                ...
                                currentSemester == "2nd" || currentSemester == "4th" || currentSemester == "6th" || currentSemester == "7th" || currentSemester == "9th"
                                ? true
                                : feeType.id_card_fee; return isClear ? "Clear" : "Pending";
                          })()}
                        </td>
                        {loginSession?.user?.user_metadata?.role === "Admin" &&
